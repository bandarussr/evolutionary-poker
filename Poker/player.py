...
class Player:
    ...
    # def make_decision(self, bet_size, min_raise, community_cards, dealer_name):
    #     if self.folded:
    #         return Action.FOLD, None
    ...
    #     player_call = (Action.FOLD, None)  # Default fallback

    #     # Define the raw numeric raise value based on logic
    #     desired_raise = None
    ...
    #         if self.traits["aggressiveness"] >= 0.7:
    #             if(self.chips.total_value() + bet_size.total_value() >= (min_raise.total_value() * 2)):
    #                 desired_raise = min_raise.total_value() * 2
    #         elif self.traits["aggressiveness"] >= 0.5:
    #             desired_raise = min_raise.total_value()
    #         else:
    #             player_call = (Action.CALL, bet_size)
    ...
    #         elif self.traits["risk_tolerance"] >= 0.5:
    #             desired_raise = min_raise.total_value()
    #         elif bet_size.total_value() < 200 and self.chips.total_value() >= 200:
    #             player_call = (Action.CALL, bet_size)
    #         elif len(community_cards) <= 3:
    #             player_call = Action.CALL, bet_size
    #         else:
    ...
    #     # Adjust raise amount based on chip size awareness
    #     if desired_raise:
    #         if self.traits["chip_size_awareness"] >= 0.7:
    #             if self.chips.total_value() >= 5000:
    #                 desired_raise += 100
    #             else:
    #                 desired_raise = max(0, desired_raise - 100)
    #         elif self.traits["chip_size_awareness"] >= 0.5:
    #             if self.chips.total_value() >= 5000:
    #                 desired_raise += 50
    #             else:
    #                 desired_raise = max(0, desired_raise - 50)

    #         # Position-based adjustment
    #         if self.name == dealer_name and self.traits["position_awareness"] > 0.6:
    #             desired_raise += 50

    #         # Convert final raise value to ChipStash
    #         try:
    #             bet_stash = self.chips.copy().dollar_to_chips(desired_raise)
    #             player_call = (Action.RAISE, bet_stash)
    #         except ValueError:
    #             player_call = (Action.CALL, bet_size)
